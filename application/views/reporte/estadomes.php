...
<div id="page-wrapper" style='margin-top: 40px;'>
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Movimientos del Mes</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        ...
        <div id="tableList">
            ...
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title">Reporte de Movimientos del Mes</h3>
                    <p class="text-muted">Flujo de Caja</p>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                           <button class="btn btn-success" onclick="verestadomes()">VER</button>
                        </div>
                    </div>
