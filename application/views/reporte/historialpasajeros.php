...
<div id="page-wrapper" style='margin-top: 40px;'>
    <div class="container-fluid">
        <div class="row bg-title">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Historial de Pasajeros</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        ...
        <div id="tableList">
            ...
            <div class="col-sm-12">
                <div class="white-box">
                    <h3 class="box-title">Reporte de Historial de Pasajeros</h3>
                    ...
                    <br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2 col-sm-6 col-xs-12">
                               <button class="btn btn-success" onclick="historialpasajeros()">GENERAR</button>
                            </div>
                        </div>
