    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Tabla Conceptos</h4> </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Concepto Movimiento</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
...
<div id="modalFormulario" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xs">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="title_form">Formulario Concepto Movimiento</h4>
            </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8 col-sm-6 col-xs-12">
            ...
            <select class='form-control form-control-line' name="idtipomovimiento">
                <option value="">Seleccione...</option>
            <?php foreach ($tipomovimientos as $tipo):?>
