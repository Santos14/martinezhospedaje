    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Tabla Tipo Alquiler</h4> </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Tipo Alquiler</li>
                </ol>
            </div>
            <!-- /.col-lg-12 -->
        </div>
...
<div id="modalFormulario" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xs">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="title_form">Formulario Tipo Alquiler</h4>
            </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8 col-sm-6 col-xs-12">
            <input type="text" id="descripcion" name="descripcion" class="form-control" placeholder="Ingrese Alquiler" required maxlength="100">
        </div>
    </div>
