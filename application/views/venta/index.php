    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Tabla Ventas</h4> </div>
...
<div id="modalFormulario" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xs">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="title_form">Formulario Ventas</h4>
            </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8 col-sm-6 col-xs-12">
            <input type="text" id="descripcion" name="descripcion" class="form-control" placeholder="Ingrese Tipo Imprevisto" required maxlength="100">
        </div>
    </div>
...
<div id="modalDetalle" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xs">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="title_form">Productos de la Venta</h4>
            </div>
            <div class="modal-body" id="listProductos">
