    ...
    <div class="container-fluid">
        <div class="row bg-title">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h4 class="page-title">Tabla Encargos</h4> </div>
...
<div id="modalFormulario" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xs">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="title_form">Formulario Almacen</h4>
            </div>
    ...
    <div class="form-group">
        <label  class="control-label col-md-3 col-sm-3 col-xs-12" for="nomalmacen">
            Nombre Almacen
        </label>
        <div class="col-md-8 col-sm-6 col-xs-12">
            <input type="text" id="nomalmacen" name="nomalmacen" class="form-control" placeholder="Ingrese Almacen" required maxlength="100">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-8 col-sm-6 col-xs-12">
            <input type="text" id="descripcion" name="descripcion" class="form-control" placeholder="Ingrese Descripcion" required maxlength="100">
        </div>
    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" onclick="save()" id='btn_save_almacen'>
                    Aceptar
                </button>
            </div>
        </div>
